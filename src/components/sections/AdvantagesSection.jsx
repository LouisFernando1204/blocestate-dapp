        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          {cardsData.map((card, index) => (
            <div
              ...
              className={`text-center p-6 bg-white/10 backdrop-blur-lg rounded-lg border border-white/20 shadow-lg transition-all duration-500 ease-in-out ${visibleCards[index]
