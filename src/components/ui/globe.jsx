...
export function World(props) {
  ...
  return (
    (<Canvas className="translate-y-10 sm:translate-y-4 md:translate-y-12 lg:translate-y-20 " scene={scene} camera={new PerspectiveCamera(40, aspect, 180, 1800)}>
      <WebGLRendererConfig />
      ...
      <directionalLight
        ...
        position={new Vector3(-100, 500, 200)} />
      <pointLight
