                  ...
                  <div
                    ...
                    <a href={`/auction/${index}`}>
                      <div class="relative h-56 w-full">
                        <div class="absolute top-0 left-0 z-10 flex items-center gap-4 p-2 text-sm text-white bg-darkBrown shadow-md rounded-br-xl">
                      ...
                      <div class="pt-6">
                        ...
                        <div class="mt-4 flex items-center justify-between gap-4">
                          ...
                          <button type="button" class="inline-flex items-center rounded-lg bg-amber-900 px-5 py-2.5 gap-2 text-sm font-medium text-white hover:bg-amber-800 focus:outline-none focus:ring-4 focus:ring-primary-300">
                            <img class="w-4" src="\images\bidding.png" alt="arrow--v1" />
                            Bid
                          </button>
                        </div>
                      </div>
